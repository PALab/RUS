...
layout = GridLayout(cols=3,rows=14)
...
c11 = TextInput(text='', multiline=False, size_hint_x=None,width=80)
c12 = TextInput(text='', multiline=False, size_hint_x=None,width=80)
c13 = TextInput(text='', multiline=False, size_hint_x=None,width=80)
c22 = TextInput(text='', multiline=False, size_hint_x=None,width=80)
c23 = TextInput(text='', multiline=False, size_hint_x=None,width=80)
c33 = TextInput(text='', multiline=False, size_hint_x=None,width=80)
c44 = TextInput(text='', multiline=False, size_hint_x=None,width=80)
c55 = TextInput(text='', multiline=False, size_hint_x=None,width=80)
c66 = TextInput(text='', multiline=False, size_hint_x=None,width=80)
shape = '2'
sc = '0'
hextype = '0'
outputArray = []
...
# layout
    def build(self):
        continueButton.bind(on_press=self.buttonClicked)
        ...
        self.vectors = TextInput(text='6', multiline=False,size_hint_x=None, width=80)
        ...
        self.dimension1 = TextInput(text='3.67', multiline=False,size_hint_x=None, width=80)
        ...
        self.dimension2 = TextInput(text='3.67', multiline=False,size_hint_x=None, width=80)
        layout.add_widget(self.dimension2)
        layout.add_widget(Label(text='cm', size_hint_x=None, width=100,))

        layout.add_widget(Label(text='Dimension 3 :', size_hint_x=None, width=100,))
        self.dimension3 = TextInput(text='3.67', multiline=False,size_hint_x=None, width=80)
        layout.add_widget(self.dimension3)
        layout.add_widget(Label(text='cm', size_hint_x=None, width=100,))

        layout.add_widget(Label(text='Density :', size_hint_x=None, width=100,))
        self.density = TextInput(text='1.7', multiline=False,size_hint_x=None, width=80)
